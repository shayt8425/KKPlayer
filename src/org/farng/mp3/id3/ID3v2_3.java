...
public class ID3v2_3 extends ID3v2_2 {
    ...
    public void setSongTitle(String songTitle) {
        ...
        if (field == null) {
            field = new ID3v2_3Frame(new FrameBodyTIT2((byte) 3, songTitle.trim()));
            setFrame(field);
        } else {
    ...
    public void setLeadArtist(String leadArtist) {
        ...
        if (field == null) {
            field = new ID3v2_3Frame(new FrameBodyTPE1((byte) 3, leadArtist.trim()));
            setFrame(field);
        } else {
    ...
    public void setAlbumTitle(String albumTitle) {
        ...
        if (field == null) {
            field = new ID3v2_3Frame(new FrameBodyTALB((byte) 3, albumTitle.trim()));
            setFrame(field);
        } else {
    ...
    public void setYearReleased(String yearReleased) {
        ...
        if (field == null) {
            field = new ID3v2_3Frame(new FrameBodyTYER((byte) 3, yearReleased.trim()));
            setFrame(field);
        } else {
    ...
    public void setSongComment(String songComment) {
        ...
        if (field == null) {
            field = new ID3v2_3Frame(new FrameBodyCOMM((byte) 3, "ENG", "", songComment.trim()));
            setFrame(field);
        } else {
    ...
    public void setSongGenre(String songGenre) {
        ...
        if (field == null) {
            field = new ID3v2_3Frame(new FrameBodyTCON((byte) 3, songGenre.trim()));
            setFrame(field);
        } else {
    ...
    public void setTrackNumberOnAlbum(String trackNumberOnAlbum) {
        ...
        if (field == null) {
            field = new ID3v2_3Frame(new FrameBodyTRCK((byte) 3, trackNumberOnAlbum.trim()));
            setFrame(field);
        } else {
    ...
    public void setSongLyric(String songLyrics) {
        ...
        if (field == null) {
            field = new ID3v2_3Frame(new FrameBodyUSLT((byte) 3, "ENG", "", songLyrics.trim()));
            setFrame(field);
        } else {
    ...
    public void setAuthorComposer(String authorComposer) {
        ...
        if (field == null) {
            field = new ID3v2_3Frame(new FrameBodyTCOM((byte) 3, authorComposer.trim()));
            setFrame(field);
        } else {
