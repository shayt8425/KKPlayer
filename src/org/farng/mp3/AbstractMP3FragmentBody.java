...
public abstract class AbstractMP3FragmentBody extends AbstractMP3FileItem {
    ...
    public String getTextEnconding(){
    	String textEnconding = "UTF-8";
    	for (Iterator i = this.iterator(); i.hasNext();) {
    		AbstractMP3Object obj = (AbstractMP3Object) i.next();
			if(obj.getIdentifier().indexOf("Encoding")>-1){
				textEnconding = TagConstant.textEncodingIdToString.get((Long)obj.getValue()).toString();
				break;
			}
		}
    	
    	return textEnconding;
    }
    ...
    public void setObject(final String identifier, final Object object) {
        ...
        while (iterator.hasNext()) {
            ...
            if (currentIdentifier.equals(identifier)) {
                ...
                abstractMP3Object.setRelateBody(this);
            }
        }
    }
